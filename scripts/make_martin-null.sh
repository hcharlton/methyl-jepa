...
python make_null_dataset.py -i "~/mutationalscanning/DerivedData/bam/HiFi/chimp/martin/kinetics/martin_kinetics_diploid.bam" -n 1_000_000 -p 0.0024 -c 32 -o null/martin_null_p0.024_n1m
